...
class AppSearchNotesDelegate extends SearchDelegate<String> {
  final List<NoteEntity> dataNotes;

  AppSearchNotesDelegate(this.dataNotes);
  ...
  Widget buildResults(BuildContext context) {
    final suggestionsNotes = dataNotes.where((notes) {
    ...
    return Padding(
      ...
      child: ListView.builder(
        itemCount: suggestionsNotes.length,
        itemBuilder: (context, index) {
          return CustomNoteCard(noteEntity: suggestionsNotes[index]);
        },
      ),
    );
  }
